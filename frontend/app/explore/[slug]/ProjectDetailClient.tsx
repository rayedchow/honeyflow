...
export default function ProjectDetailClient({
  ...
  const baseRaisedUsd = typeof project.raised === "number" ? project.raised : parseFloat(String(project.raised)) || 0;
  const raised = showUsd
    ? `$${(baseRaisedUsd + raisedBonus * ETH_TO_USD).toLocaleString(undefined, { maximumFractionDigits: 0 })}`
    : `${(baseRaisedUsd / ETH_TO_USD + raisedBonus).toFixed(2)} ETH`;
  ...
  return (
    <div className="px-8 py-8">
      ...
      {/* Dependencies + Top Contributors — full width below the two-column layout */}
