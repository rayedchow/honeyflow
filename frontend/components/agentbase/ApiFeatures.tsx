...
export default function ApiFeatures() {
    return (
        <section className="w-full py-12 bg-white border-b border-agentbase-border">
            <div className="px-8">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start justify-between">
                    ...
                    <div className="md:w-1/2 flex flex-col space-y-5">
                        ...
                        <div className="pt-2">
                            <Link
                                href="/docs"
                                className="px-6 py-3 bg-black text-white font-mono text-xs tracking-widest uppercase font-bold rounded-full hover:bg-gray-800 transition-colors inline-block"
                            >
                                Read Docs →
                            </Link>
                        </div>
                    ...
                    <div className="md:w-1/2 w-full flex flex-col border border-agentbase-border bg-white shadow-sm">

                        <div className="p-6 border-b border-agentbase-border hover:bg-gray-50 transition-colors group cursor-pointer">
                            <div className="flex items-center space-x-4 mb-2">
                                ...
                                <h3 className="text-lg font-bold text-black tracking-tight">Fund</h3>
                            </div>
                            <p className="text-[#666666] text-sm pl-9">
                        ...
                        <div className="p-6 border-b border-agentbase-border hover:bg-gray-50 transition-colors group cursor-pointer">
                            <div className="flex items-center space-x-4 mb-2">
                                <div className="text-[#888888] group-hover:text-agentbase-cyan transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <polyline points="16 18 22 12 16 6"></polyline>
                                        <polyline points="8 6 2 12 8 18"></polyline>
                                    </svg>
                                </div>
                                <h3 className="text-lg font-bold text-black tracking-tight">Map</h3>
                            </div>
                            <p className="text-[#666666] text-sm pl-9">
                        ...
                        <div className="p-6 hover:bg-gray-50 transition-colors group cursor-pointer">
                            <div className="flex items-center space-x-4 mb-2">
                                ...
                                <h3 className="text-lg font-bold text-black tracking-tight">Flow</h3>
                            </div>
                            <p className="text-[#666666] text-sm pl-9">
